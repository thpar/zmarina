                ...
                "fnClick": function (nButton, oConfig) {
                    ...
                    $.ajax({
                        ...
                        success: function () {
                            ...
                            $(nButton).html('<span class="hint--top" aria-label="Save current search results to active GeneList"><i class="fa fa-floppy-o  fa-2x" aria-hidden="true"></i></span>');
...

			{
                ...
                "fnClick": function (nButton, oConfig) {
                    ...
                    for (i = 0; i < columns.length; i++) {
					 ...
					 var new_gene_list_name = prompt("Please enter new Gene List name", "new list");
                ...
                "fnClick": function (nButton, oConfig) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            hm.wHumanMsg('Shared Link: <a target="_blank" href="' + "/?table=" + data.trim() + '">http://zmarina.plantgenie.org/?table=' + data.trim() + '</a>', {
                                theme: 'cream',
                                opacity: 1,
                                displayLength: 30000
                            });
