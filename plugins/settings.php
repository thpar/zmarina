...
$db_species_array=array("zmarina"=>"eucalyptus grandis public","zmarina"=>"eucalyptus grandis private");

/*Here you can listed background colors correspond to each species. eg: "database_1" => "#FF0000",*/
global $db_species_color_array;
$db_species_color_array=array("zmarina"=>"#0087be","zmarina"=>"#0087be");
...
global $db_url;
$db_url=  array ('genelist'=>'mysqli://popuser:poppass@localhost/'.$selected_database);

/*Define your base url with trailing slash*/
$GLOBALS["base_url"]='http://zmarina.plantgenie.org/';
